				...
				<div class="bradcam_text text-center">
					...
					<nav class="brad_cam_lists">
						<ul class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page">Daftar Ide</li>
						</ul>
					</nav>
				</div>
			</div>
...
<div class="case_study_area white_case_study">
	...
	<div class="container">
		<a class="boxed-btn3 mb-5" href="<?= base_url('idea/add') ?>">AJUKAN IDEMU</a>
		<div class="row">
			<?php 
				...
				foreach ($data_idea as $row) {
					...
					<div class="col-lg-4 col-md-6">
						<div class="single_study text-center white_single_study">
							<div class="thumb">
								<a href="javascript:void(0);" class="view-idea" data-idea="<?= $row->idea_id; ?>" >
									<img src="<?= base_url(); ?>assets/images/idea/<?= $row->idea_photo ?>" alt="">
								</a>
							</div>
							<div class="subheading white_subheading">
								<h4><a href="javascript:void(0);" class="view-idea" data-idea="<?= $row->idea_id; ?>" ><?= $row->idea_subject ?></a></h4>
								<p><?= $idea_type; ?></p>
							</div>
						</div>
					</div>
