				...
				<div class="bradcam_text text-center">
					...
					<nav class="brad_cam_lists">
						<ul class="breadcrumb">
							...
							<li class="breadcrumb-item"><a href="<?= base_url('approval/verification_idea'); ?>">Verifikasi Ide</a></li>
							<li class="breadcrumb-item active" aria-current="page">Detail Verifikasi Ide</li>
						</ul>
					</nav>
				</div>
			</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 posts-list">
				...
				<a id="btn-verification" class="boxed-btn3 mt-5" href="#" data-value="1" data-idea="<?= $idea_id; ?>" style="color: #fff !important">Verifikasi Ide</a> 
				<a id="btn-verification" class="boxed-btn3 mt-5 ml-5" href="#" data-value="3" data-idea="<?= $idea_id; ?>" style="color: #fff !important">Tidak Verifikasi Ide</a>
		...
		<div class="modal-content">
			<form method="POST" id="reject-form" accept-charset="UTF-8">
				...
				<div class="modal-footer">
					...
					<button type="submit" id="btn-submit" class="btn btn-danger">Tidak Verifikasi</button>
				</div>
			</form>
		</div>
	</div>
