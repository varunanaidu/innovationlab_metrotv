				...
				<div class="bradcam_text text-center">
					...
					<nav class="brad_cam_lists">
						<ul class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page">Verifikasi Ide</li>
						</ul>
					</nav>
				</div>
			</div>
				...
				foreach ($data_idea as $row) {
					...
					<div class="col-lg-4 col-md-6">
						<div class="single_study text-center white_single_study">
							<div class="thumb">
								<a href="<?= base_url('approval/details_verification/').$row->idea_id; ?>" class="view-idea" data-idea="<?= $row->idea_id; ?>">
									<img src="<?= base_url(); ?>assets/images/idea/<?= $row->idea_photo ?>" alt="">
								</a>
							</div>
							<div class="subheading white_subheading">
								<h4><a href="<?= base_url('approval/details_verification/').$row->idea_id; ?>" class="view-idea" data-idea="<?= $row->idea_id; ?>" ><?= $row->idea_subject ?></a></h4>
								<p><?= $idea_type; ?></p>
							</div>
						</div>
					</div>
